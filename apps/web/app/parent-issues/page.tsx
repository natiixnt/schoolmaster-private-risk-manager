     ...
     <div>
        ...
        <div className="sm-bg-hero rounded-[var(--sm-radius-lg)]  shadow-2xl shadow-[var(--sm-color-info-600)]/30 mb-6 border-b-8 border-white/10 relative overflow-hidden">
           ...
           <svg viewBox="0 0 960 540" width="100%" height="100%" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="bg-white hover:bg-indigo-50 text-[var(--sm-color-text-primary)] cursor-pointer w-12 h-12 flex items-center justify-center rounded-xl transition-all shadow-lg active:scale-95">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-6 h-6">
                   <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              </button>
            ...
            <div className="flex gap-2">
              {['all', 'NEW', 'IN_PROGRESS', 'RESOLVED'].map((s) => (
                <button
                  ...
                  className={`px-5 py-2 rounded-xl text-xs cursor-pointer font-black uppercase tracking-tighter transition-all ${
                    filterStatus === s 
